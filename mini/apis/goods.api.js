...
export class GoodsApi{
    ...
    hotgoods(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'goods/hotgoods',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    indexcat(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'goods/indexcat',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    photolist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'goods/photolist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
  ...
  attrinfo(json, callback, showLoading = true) {
    ...
    console.log(json);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'goods/attrinfo',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
